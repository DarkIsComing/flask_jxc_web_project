...
function buy_submit(obj){
    ...
    $.ajax({
        ...
        success:function() {
            alert('进货成功!')
            window.location.href ="/search?words="+words+'&page='+page
        },
        error:function(){
            alert('服务器错误')
        }
...
function sale_submit(obj){
    ...
    $.ajax({
        ...
        success:function(data) {
            ...
            window.location.href ="/search?page="+page+'&words='+words
            //window.location.href ="{{ url_for('main.search_material_list',words=words,page=page)}}"
            //window.location =("{{ url_for('main.search_material_list')}}"+'?page='+page+'&words='+words)
        },
        error:function(){
            alert('服务器错误')
        }
